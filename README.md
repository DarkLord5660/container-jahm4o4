...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-jahm4o4.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-jahm4o4.containers.anotherwebservice.com/
...
```
git clone git@github.com:DarkLord5660/container-jahm4o4.git
cd container-jahm4o4
```
...
```
docker attach container-jahm4o4
```
